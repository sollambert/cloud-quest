...
'{"interactables":[
	{
		...
		"use": {
			"fuse": {
				"effect": {
					"electricity": true,
					"new_description": "With the new fuse, the generator is humming with life after a quick pull of the rip cord."
				},
				"message": "You insert the fuse, pull the ripcord, and the generator springs to life with a roar!"
			}
		}
	},
	{
